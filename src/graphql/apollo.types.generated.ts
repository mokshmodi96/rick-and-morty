...
export function useFetchCharactersSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchCharactersQuery, FetchCharactersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchCharactersQuery, FetchCharactersQueryVariables>(FetchCharactersDocument, options);
        }
...
export type FetchCharactersSuspenseQueryHookResult = ReturnType<typeof useFetchCharactersSuspenseQuery>;
...
export function useFetchCharacterSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchCharacterQuery, FetchCharacterQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchCharacterQuery, FetchCharacterQueryVariables>(FetchCharacterDocument, options);
        }
...
export type FetchCharacterSuspenseQueryHookResult = ReturnType<typeof useFetchCharacterSuspenseQuery>;
